...
class WhirlpoolContext {
    ...
    txBuilderOpts;
    accountResolverOpts;
    static from(connection, wallet, fetcher = (0, public_1.buildDefaultAccountFetcher)(connection), lookupTableFetcher, opts = {}, programId) {
        ...
        const program = new anchor_1.Program(getWhirlpoolIdl(programId), anchorProvider);
    ...
    static withProvider(provider, fetcher = (0, public_1.buildDefaultAccountFetcher)(provider.connection), lookupTableFetcher, opts = {}, programId) {
        const program = new anchor_1.Program(getWhirlpoolIdl(programId), provider);
        return new WhirlpoolContext(provider, provider.wallet, program, fetcher, lookupTableFetcher, opts);
    }
...
function getWhirlpoolIdl(programId) {
    if (programId === undefined) {
        return whirlpool_json_1.default;
    }
    return { ...whirlpool_json_1.default, address: programId.toBase58() };
}
