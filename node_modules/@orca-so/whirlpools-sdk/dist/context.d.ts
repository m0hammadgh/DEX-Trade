...
export declare class WhirlpoolContext {
    ...
    static from(connection: Connection, wallet: Wallet, fetcher?: WhirlpoolAccountFetcherInterface, lookupTableFetcher?: LookupTableFetcher, opts?: WhirlpoolContextOpts, programId?: PublicKey): WhirlpoolContext;
    ...
    static withProvider(provider: AnchorProvider, fetcher?: WhirlpoolAccountFetcherInterface, lookupTableFetcher?: LookupTableFetcher, opts?: WhirlpoolContextOpts, programId?: PublicKey): WhirlpoolContext;
