...
exports.increaseLiquidityQuoteByInputTokenUsingPriceDeviation = increaseLiquidityQuoteByInputTokenUsingPriceDeviation;
...
exports.increaseLiquidityQuoteByInputTokenWithParamsUsingPriceDeviation = increaseLiquidityQuoteByInputTokenWithParamsUsingPriceDeviation;
...
function increaseLiquidityQuoteByInputTokenUsingPriceDeviation(inputTokenMint, inputTokenAmount, tickLower, tickUpper, priceDeviation, whirlpool, tokenExtensionCtx) {
    const data = whirlpool.getData();
    const tokenAInfo = whirlpool.getTokenAInfo();
    const tokenBInfo = whirlpool.getTokenBInfo();
    const inputMint = common_sdk_1.AddressUtil.toPubKey(inputTokenMint);
...
function increaseLiquidityQuoteByInputTokenWithParamsUsingPriceDeviation(param, priceDeviation) {
    const quote = increaseLiquidityQuoteByInputTokenWithParams(param);
    const { lowerBound: [minSqrtPrice], upperBound: [maxSqrtPrice], } = public_1.PriceMath.getSlippageBoundForSqrtPrice(param.sqrtPrice, priceDeviation);
    return {
        ...quote,
        minSqrtPrice,
        maxSqrtPrice,
