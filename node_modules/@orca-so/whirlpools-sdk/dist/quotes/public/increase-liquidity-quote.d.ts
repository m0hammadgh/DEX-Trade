...
export declare function increaseLiquidityQuoteByInputTokenUsingPriceDeviation(inputTokenMint: Address, inputTokenAmount: Decimal, tickLower: number, tickUpper: number, priceDeviation: Percentage, whirlpool: Whirlpool, tokenExtensionCtx: TokenExtensionContextForPool): IncreaseLiquidityQuoteWithPriceBounds;
...
export declare function increaseLiquidityQuoteByInputTokenWithParamsUsingPriceDeviation(param: IncreaseLiquidityQuoteParam, priceDeviation: Percentage): IncreaseLiquidityQuoteWithPriceBounds;
